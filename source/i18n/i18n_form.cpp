...
namespace
{
    ...
    constexpr bool comp(const std::span<const size_t>&, const std::span<const size_t>&)
    {
        return true;
    }

    // clang-format off
    constexpr BidirectionalMap speciesforms = {std::equal_to<>(), &comp,
        pksm::Species(pksm::Species::Venusaur), std::span<const size_t>(Venusaur),
        pksm::Species::Charizard, Charizard,
        pksm::Species::Blastoise, Blastoise,
        pksm::Species::Beedrill, Beedrill,
        pksm::Species::Pidgeot, Pidgeot,
        pksm::Species::Rattata, Rattata,
        pksm::Species::Raticate, Raticate,
        pksm::Species::Raichu, Raichu,
        pksm::Species::Sandslash, Sandslash,
        pksm::Species::Ninetales, Ninetales,
        pksm::Species::Dugtrio, Dugtrio,
        pksm::Species::Meowth, Meowth,
        pksm::Species::Persian, Persian,
        pksm::Species::Alakazam, Alakazam,
        pksm::Species::Golem, Golem,
        pksm::Species::Rapidash, Rapidash,
        pksm::Species::Slowpoke, Slowpoke,
        pksm::Species::Slowbro, Slowbro,
        pksm::Species::Slowking, Slowking,
        pksm::Species::Farfetchd, Farfetchd,
        pksm::Species::Muk, Muk,
        pksm::Species::Gengar, Gengar,
        pksm::Species::Exeggutor, Exeggutor,
        pksm::Species::Marowak, Marowak,
        pksm::Species::Weezing, Weezing,
        pksm::Species::MrMime, MrMime,
        pksm::Species::Kangaskhan, Kangaskhan,
        pksm::Species::Pinsir, Pinsir,
        pksm::Species::Gyarados, Gyarados,
        pksm::Species::Aerodactyl, Aerodactyl,
        pksm::Species::Articuno, Articuno,
        pksm::Species::Zapdos, Zapdos,
        pksm::Species::Moltres, Moltres,
        pksm::Species::Mewtwo, Mewtwo,
        pksm::Species::Pichu, Pichu,
        pksm::Species::Ampharos, Ampharos,
        pksm::Species::Unown, Unown,
        pksm::Species::Steelix, Steelix,
        pksm::Species::Scizor, Scizor,
        pksm::Species::Heracross, Heracross,
        pksm::Species::Corsola, Corsola,
        pksm::Species::Houndoom, Houndoom,
        pksm::Species::Tyranitar, Tyranitar,
        pksm::Species::Sceptile, Sceptile,
        pksm::Species::Blaziken, Blaziken,
        pksm::Species::Swampert, Swampert,
        pksm::Species::Linoone, Linoone,
        pksm::Species::Gardevoir, Gardevoir,
        pksm::Species::Sableye, Sableye,
        pksm::Species::Mawile, Mawile,
        pksm::Species::Aggron, Aggron,
        pksm::Species::Medicham, Medicham,
        pksm::Species::Manectric, Manectric,
        pksm::Species::Sharpedo, Sharpedo,
        pksm::Species::Camerupt, Camerupt,
        pksm::Species::Altaria, Altaria,
        pksm::Species::Castform, Castform,
        pksm::Species::Banette, Banette,
        pksm::Species::Absol, Absol,
        pksm::Species::Glalie, Glalie,
        pksm::Species::Salamence, Salamence,
        pksm::Species::Metagross, Metagross,
        pksm::Species::Latias, Latias,
        pksm::Species::Latios, Latios,
        pksm::Species::Kyogre, Kyogre,
        pksm::Species::Groudon, Groudon,
        pksm::Species::Rayquaza, Rayquaza,
        pksm::Species::Deoxys, Deoxys,
        pksm::Species::Burmy, Burmy,
        pksm::Species::Wormadam, Wormadam,
        pksm::Species::Cherrim, Cherrim,
        pksm::Species::Shellos, Shellos,
        pksm::Species::Gastrodon, Gastrodon,
        pksm::Species::Lopunny, Lopunny,
        pksm::Species::Garchomp, Garchomp,
        pksm::Species::Lucario, Lucario,
        pksm::Species::Abomasnow, Abomasnow,
        pksm::Species::Gallade, Gallade,
        pksm::Species::Rotom, Rotom,
        pksm::Species::Giratina, Giratina,
        pksm::Species::Shaymin, Shaymin,
        pksm::Species::Arceus, Arceus,
        pksm::Species::Audino, Audino,
        pksm::Species::Basculin, Basculin,
        pksm::Species::Darumaka, Darumaka,
        pksm::Species::Darmanitan, Darmanitan,
        pksm::Species::Yamask, Yamask,
        pksm::Species::Sawsbuck, Sawsbuck,
        pksm::Species::Stunfisk, Stunfisk,
        pksm::Species::Tornadus, Tornadus,
        pksm::Species::Thundurus, Thundurus,
        pksm::Species::Landorus, Landorus,
        pksm::Species::Kyurem, Kyurem,
        pksm::Species::Keldeo, Keldeo,
        pksm::Species::Meloetta, Meloetta,
        pksm::Species::Genesect, Genesect,
        pksm::Species::Greninja, Greninja,
        pksm::Species::Vivillon, Vivillon,
        pksm::Species::Flabebe, Flabebe,
        pksm::Species::Floette, Floette,
        pksm::Species::Florges, Florges,
        pksm::Species::Furfrou, Furfrou,
        pksm::Species::Meowstic, Meowstic,
        pksm::Species::Aegislash, Aegislash,
        pksm::Species::Pumpkaboo, Pumpkaboo,
        pksm::Species::Gourgeist, Gourgeist,
        pksm::Species::Zygarde, Zygarde,
        pksm::Species::Diancie, Diancie,
        pksm::Species::Hoopa, Hoopa,
        pksm::Species::Gumshoos, Gumshoos,
        pksm::Species::Vikavolt, Vikavolt,
        pksm::Species::Oricorio, Oricorio,
        pksm::Species::Ribombee, Ribombee,
        pksm::Species::Rockruff, Rockruff,
        pksm::Species::Lycanroc, Lycanroc,
        pksm::Species::Wishiwashi, Wishiwashi,
        pksm::Species::Araquanid, Araquanid,
        pksm::Species::Lurantis, Lurantis,
        pksm::Species::Salazzle, Salazzle,
        pksm::Species::Silvally, Silvally,
        pksm::Species::Minior, Minior,
        pksm::Species::Togedemaru, Togedemaru,
        pksm::Species::Mimikyu, Mimikyu,
        pksm::Species::Kommoo, Kommoo,
        pksm::Species::Necrozma, Necrozma,
        pksm::Species::Magearna, Magearna,
        pksm::Species::Cramorant, Cramorant,
        pksm::Species::Toxtricity, Toxtricity,
        pksm::Species::Indeedee, Indeedee,
        pksm::Species::Polteageist, Polteageist,
        pksm::Species::Alcremie, Alcremie,
        pksm::Species::Morpeko, Morpeko,
        pksm::Species::Eiscue, Eiscue,
        pksm::Species::Zacian, Zacian,
        pksm::Species::Zamazenta, Zamazenta,
        pksm::Species::Eternatus, Eternatus,
        pksm::Species::Urshifu, Urshifu,
        pksm::Species::Zarude, Zarude,
        pksm::Species::Calyrex, Calyrex
    };
    // clang-format on
}
