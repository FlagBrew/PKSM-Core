...
namespace pksm
{
    ...
    const std::set<Species>& VersionTables::availableSpecies(GameVersion version)
    {
        ...
        switch (version)
        {
            ...
            case GameVersion::PLA:
            {
                static const std::set<Species> items = {Species::Pikachu, Species::Raichu,
                    Species::Clefairy, Species::Clefable, Species::Vulpix, Species::Ninetales,
                    Species::Zubat, Species::Golbat, Species::Paras, Species::Parasect,
                    Species::Psyduck, Species::Golduck, Species::Growlithe, Species::Arcanine,
                    Species::Abra, Species::Kadabra, Species::Alakazam, Species::Machop,
                    Species::Machoke, Species::Machamp, Species::Tentacool, Species::Tentacruel,
                    Species::Geodude, Species::Graveler, Species::Golem, Species::Ponyta,
                    Species::Rapidash, Species::Magnemite, Species::Magneton, Species::Gastly,
                    Species::Haunter, Species::Gengar, Species::Onix, Species::Voltorb,
                    Species::Electrode, Species::Lickitung, Species::Rhyhorn, Species::Rhydon,
                    Species::Chansey, Species::Tangela, Species::MrMime, Species::Scyther,
                    Species::Electabuzz, Species::Magmar, Species::Magikarp, Species::Gyarados,
                    Species::Eevee, Species::Vaporeon, Species::Jolteon, Species::Flareon,
                    Species::Porygon, Species::Snorlax, Species::Cyndaquil, Species::Quilava,
                    Species::Typhlosion, Species::Crobat, Species::Pichu, Species::Cleffa,
                    Species::Togepi, Species::Togetic, Species::Sudowoodo, Species::Aipom,
                    Species::Yanma, Species::Espeon, Species::Umbreon, Species::Murkrow,
                    Species::Misdreavus, Species::Unown, Species::Gligar, Species::Steelix,
                    Species::Qwilfish, Species::Scizor, Species::Heracross, Species::Sneasel,
                    Species::Teddiursa, Species::Ursaring, Species::Swinub, Species::Piloswine,
                    Species::Remoraid, Species::Octillery, Species::Mantine, Species::Porygon2,
                    Species::Stantler, Species::Elekid, Species::Magby, Species::Blissey,
                    Species::Wurmple, Species::Silcoon, Species::Beautifly, Species::Cascoon,
                    Species::Dustox, Species::Ralts, Species::Kirlia, Species::Gardevoir,
                    Species::Nosepass, Species::Roselia, Species::Barboach, Species::Whiscash,
                    Species::Duskull, Species::Dusclops, Species::Chimecho, Species::Snorunt,
                    Species::Glalie, Species::Spheal, Species::Sealeo, Species::Walrein,
                    Species::Turtwig, Species::Grotle, Species::Torterra, Species::Chimchar,
                    Species::Monferno, Species::Infernape, Species::Piplup, Species::Prinplup,
                    Species::Empoleon, Species::Starly, Species::Staravia, Species::Staraptor,
                    Species::Bidoof, Species::Bibarel, Species::Kricketot, Species::Kricketune,
                    Species::Shinx, Species::Luxio, Species::Luxray, Species::Budew,
                    Species::Roserade, Species::Cranidos, Species::Rampardos, Species::Shieldon,
                    Species::Bastiodon, Species::Burmy, Species::Wormadam, Species::Mothim,
                    Species::Combee, Species::Vespiquen, Species::Pachirisu, Species::Buizel,
                    Species::Floatzel, Species::Cherubi, Species::Cherrim, Species::Shellos,
                    Species::Gastrodon, Species::Ambipom, Species::Drifloon, Species::Drifblim,
                    Species::Buneary, Species::Lopunny, Species::Mismagius, Species::Honchkrow,
                    Species::Glameow, Species::Purugly, Species::Chingling, Species::Stunky,
                    Species::Skuntank, Species::Bronzor, Species::Bronzong, Species::Bonsly,
                    Species::MimeJr, Species::Happiny, Species::Chatot, Species::Spiritomb,
                    Species::Gible, Species::Gabite, Species::Garchomp, Species::Munchlax,
                    Species::Riolu, Species::Lucario, Species::Hippopotas, Species::Hippowdon,
                    Species::Skorupi, Species::Drapion, Species::Croagunk, Species::Toxicroak,
                    Species::Carnivine, Species::Finneon, Species::Lumineon, Species::Mantyke,
                    Species::Snover, Species::Abomasnow, Species::Weavile, Species::Magnezone,
                    Species::Lickilicky, Species::Rhyperior, Species::Tangrowth,
                    Species::Electivire, Species::Magmortar, Species::Togekiss, Species::Yanmega,
                    Species::Leafeon, Species::Glaceon, Species::Gliscor, Species::Mamoswine,
                    Species::PorygonZ, Species::Gallade, Species::Probopass, Species::Dusknoir,
                    Species::Froslass, Species::Rotom, Species::Uxie, Species::Mesprit,
                    Species::Azelf, Species::Dialga, Species::Palkia, Species::Heatran,
                    Species::Regigigas, Species::Giratina, Species::Cresselia, Species::Phione,
                    Species::Manaphy, Species::Darkrai, Species::Shaymin, Species::Arceus,
                    Species::Oshawott, Species::Dewott, Species::Samurott, Species::Petilil,
                    Species::Lilligant, Species::Basculin, Species::Zorua, Species::Zoroark,
                    Species::Rufflet, Species::Braviary, Species::Tornadus, Species::Thundurus,
                    Species::Landorus, Species::Sylveon, Species::Goomy, Species::Sliggoo,
                    Species::Goodra, Species::Bergmite, Species::Avalugg, Species::Rowlet,
                    Species::Dartrix, Species::Decidueye, Species::Wyrdeer, Species::Kleavor,
                    Species::Ursaluna, Species::Basculegion, Species::Sneasler, Species::Overqwil,
                    Species::Enamorus};
                return items;
            }
            default:
    ...
    const std::set<Ball>& VersionTables::availableBalls(GameVersion version)
    {
        ...
        if (version == GameVersion::SL || version == GameVersion::VL || version == GameVersion::ZA)
        {
            static const std::set<Ball> items = std::invoke(
                []()
                {
                    return create_set_consecutive<Ball>(Ball::Master, Ball::Beast);
                }); // LAOrigin exists in these games too technically, but Beast for now
            return items;
        }
