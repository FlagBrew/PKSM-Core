        ...
        switch (version)
        {
            ...
            case GameVersion::SV:
            {
                static const std::set<int> items = {
                    ...
                    44, 46, 47, 48, 49, 51, 52, 53, 54, 55, 57, 58, 59, 60, 61, 62, 63, 64, 65, 66,
                    67, 68, 69, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87,
                    88, 89, 91, 92, 93, 94, 95, 96, 97, 98, 99, 101, 102, 103, 104, 105, 106, 107,
                    108, 109, 110, 111, 112, 113, 114, 117, 118, 119, 121, 122, 123, 124, 125, 126,
                    127, 128, 130, 131, 132, 133, 134, 138, 139, 140, 143, 144, 146, 150, 151, 152,
                    156, 157, 158, 159, 160, 161, 163, 164, 165, 166, 167, 168, 169, 170, 172, 173,
                    174, 175, 178, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 191, 192, 193,
                    194, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210,
                    211, 212, 213, 214, 215, 216, 217, 218, 219, 221, 222, 223, 224, 225, 226, 227,
            ...
            case GameVersion::C:
            {
                static const std::set<int> items = {
                    ...
                    87, 88, 89, 91, 92, 93, 94, 95, 96, 97, 98, 99, 101, 102, 103, 104, 105, 106,
                    107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 121, 122, 123,
                    124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 138, 139, 140, 143, 144,
                    146, 150, 151, 152, 156, 157, 158, 159, 160, 161, 163, 164, 165, 166, 167, 168,
                    169, 170, 172, 173, 174, 175, 178, 180, 181, 182, 183, 184, 185, 186, 187, 188,
                    189, 191, 192, 193, 194, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206,
        ...
        switch ((Generation)version)
        {
            ...
            case Generation::TWO:
            {
                static const std::set<Ball> items = {
                    Ball::Master, Ball::Ultra, Ball::Great, Ball::Poke, Ball::Safari, Ball::Fast,
                    Ball::Level, Ball::Lure, Ball::Heavy, Ball::Love, Ball::Friend, Ball::Moon
                };
                return items;
            }
