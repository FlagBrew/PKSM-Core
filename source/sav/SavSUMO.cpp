...
namespace pksm
{
    ...
    std::map<Sav::Pouch, std::vector<int>> SavSUMO::validItems() const
    {
        return {{Pouch::NormalItem,
            ...
            {Pouch::KeyItem, {216, 465, 466, 628, 629, 631, 632, 638, 705, 706, 765, 773, 797, 841, 842, 843, 845, 847, 850, 857, 858, 860}},
            {Pouch::TM,
