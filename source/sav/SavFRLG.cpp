...
std::map<Sav::Pouch, std::vector<int>> SavFRLG::validItems() const
{
    std::map<Sav::Pouch, std::vector<int>> items = {
        ...
        {KeyItem, {259, 260, 261, 262, 263, 264, 265, 266, 268, 269, 270, 271, 272, 273, 274, 275, 276, 277, 278, 279, 280, 281, 282, 283, 284, 285, 286, 287, 288, 349, 350, 351, 352, 353, 354, 355, 356, 357, 358, 359, 360, 361, 362, 363, 364, 365, 366, 367, 368, 369, 370, 371, 372, 373, 374}},
