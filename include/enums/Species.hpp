...
namespace pksm
{
    ...
    namespace internal
    {
        ...
        private:
            enum class SpeciesEnum : u16
            {
                ...
                INVALID[[maybe_unused]] = std::numeric_limits<std::underlying_type_t<SpeciesEnum>>::max()
            } v;
    ...
    public:
        ...
        constexpr bool operator<(const internal::Species_impl& other) const noexcept { return impl < other; }
        constexpr bool operator<=(const internal::Species_impl& other) const noexcept { return impl <= other; }
