...
namespace pksm
{
    ...
    public:
        ...
        [[nodiscard]] std::string_view extension() const override { return ".pk9"; }
        ...
        [[nodiscard]] u8 teraTypeOriginal(void) const;
        void teraTypeOriginal(u8 v);
        [[nodiscard]] u8 teraTypeOverride(void) const;
        void teraTypeOverride(u8 v);
