...
public:
    ...
    inline u8 type1(void) const override { return PersonalRSFRLGE::type1(formSpecies()); }
    inline u8 type2(void) const override { return PersonalRSFRLGE::type2(formSpecies()); }
    ...
    inline u16 abilities(u8 n) const override { return PersonalRSFRLGE::ability(formSpecies(), n); }
